...
const name = outlet?.outletName || "K's Chicken";

const address =
  addressParts.length > 0
    ? addressParts.join(", ")
    : "135 Wennington Road, Rainham RM13 9TR";

const phone = outlet?.phone || "01708780264";
...
<p className="max-w-2xl mx-auto mt-5 text-neutral-600">
  Your neighbourhood stop for golden fried chicken, wings,
  burgers, chips, and family boxes. Visit us on Wennington Road
  or give us a call—we'd love to serve you.
</p>
